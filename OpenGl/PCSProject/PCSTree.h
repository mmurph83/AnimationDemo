...
private:
	...
	void CheckDepth();
	void DismantleTree();
	void RemoveChildren(PCSNode* pNode);
	PCSNode* FindPrevReverseNode(PCSNode* pNode);
	PCSNode* FindNextReverseNode(PCSNode* pNode);
	PCSNode* FindLastForwardNode(PCSNode* pNode);
};
