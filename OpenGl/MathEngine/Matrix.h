...
public:
	...
	Matrix(RotOrientType type, const Vect &v1, const Vect & v2);
	Matrix(RotAxisAngleType type, const Vect &v1, const float &fl);
	Matrix(Rot3AxisType type, const float x, const float y, const float z);
	...
	void set(Rot3AxisType type, const float x, const float y, const float z);
