...
void ShaderObject::SendView(Matrix& view)
{
	glUniformMatrix4fv(GetLocation("view_matrix"), 1, GL_FALSE, (float *)&view);
}
void ShaderObject::SendProjection(Matrix& proj)
{
	glUniformMatrix4fv(GetLocation("proj_matrix"), 1, GL_FALSE, (float *)&proj);
}
void ShaderObject::SendWorld(Matrix& world)
{
	glUniformMatrix4fv(GetLocation("world_matrix"), 1, GL_FALSE, (float *)&world);
}
